                            ...
                            <div className="space-y-2">
                                {grouped[cat].map(product => (
                                    <div
                                        ...
                                        className="bg-white p-4 rounded-2xl border border-slate-100 shadow-sm flex justify-between items-center group active:scale-[0.99] transition-all cursor-pointer"
                                    >
                                        <div>
                                            <p className="font-bold text-slate-800">{product.name}</p>
                                            <p className="text-xs font-medium text-slate-400">{product.price.toFixed(2)} kr</p>
                                        </div>
                                        <div className="flex items-center gap-2">
                                            ...
                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" className="text-slate-200"><path d="m9 18 6-6-6-6" /></svg>
                                        </div>
                                    </div>
                                ))}
                            </div>
